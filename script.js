...
function calcularConsumo() {
  ...
  var totalRefriAdultos = selecoesBebidas.includes("Refrigerante") ? 3 * adultos + ' latas' : "0 latas";
  var totalRefriCriancas = selecoesBebidas.includes("Refrigerante") ? 2 * criancas + ' latas' : "0 latas";
  ...
  localStorage.setItem('totalRefriAdultos', totalRefriAdultos);
  localStorage.setItem('totalRefriCriancas', totalRefriCriancas);
